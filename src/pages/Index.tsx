        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#b9bbbe] hidden sm:block">Мессенджер и соцсеть нового поколения</p>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          >
            <div className="p-4 border-b border-[#202225] flex items-center justify-between">
              <h2 className="text-white font-semibold text-base">Волна</h2>
              <Button
                variant="ghost"
            ...
            <div className="flex-1 p-2">
              <div className="mb-4">
                ...
                <div className="mt-1 space-y-0.5">
                  {["лента", "новости", "знакомства", "помощь"].map((channel) => (
                    <div
                      key={channel}
            ...
            <div className="p-2 bg-[#292b2f] flex items-center gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[#b9bbbe] text-xs truncate">#0042</div>
              </div>
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="h-12 bg-[#36393f] border-b border-[#202225] flex items-center px-4 gap-2">
              ...
              <span className="text-[#8e9297] text-sm hidden sm:block">Общайся, делись, будь собой — это Волна</span>
            ...
            <div className="flex-1 p-2 sm:p-4 space-y-4 sm:space-y-6 overflow-y-auto">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    <p className="mb-3 sm:mb-4">
                      <strong>Добро пожаловать в Волну!</strong> Мессенджер и соцсеть, где общение — это главное.
                    </p>
                    <div className="bg-[#2f3136] border-l-4 border-[#5865f2] p-3 sm:p-4 rounded">
                      ...
                      <ul className="space-y-1 text-xs sm:text-sm text-[#b9bbbe]">
                        ...
                        <li>Лента новостей и публикации для друзей</li>
                        <li>Голосовые и видеозвонки в один клик</li>
                        <li>Истории, реакции и стикеры</li>
              ...
              {/* Сообщение пользователя с демо-профилем */}
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] mb-3 text-sm sm:text-base">
                    Только зарегистрировалась — уже нашла всех друзей!
                  </div>
                    ...
                    <div className="pt-4 sm:pt-6 px-3 sm:px-4 pb-3 sm:pb-4">
                      ...
                      <div className="mb-3 sm:mb-4">
                        <div className="bg-[#36393f] rounded-lg p-2 sm:p-3 relative">
                          ...
                          <div className="flex items-center gap-2 text-[#dcddde] text-xs sm:text-sm">
                            <Smile className="w-3 h-3 sm:w-4 sm:h-4 text-[#5865f2]" />
                      ...
                      <div>
                        ...
                        <div className="flex items-start gap-2 sm:gap-3 p-2 sm:p-3 bg-[#36393f] rounded-lg">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="text-white font-semibold text-xs sm:text-sm mb-1">Волна</div>
                            <div className="text-[#dcddde] text-xs sm:text-sm mb-1">Общается в группе «Путешественники»</div>
                            <div className="text-[#b9bbbe] text-xs sm:text-sm mb-2">124 участника онлайн</div>
              ...
              <div className="flex gap-2 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[#dcddde] text-sm sm:text-base">
                    Наконец-то нашёл соцсеть где нет лишнего шума! Волна — это то, что нужно 🙌
                  </div>
                </div>
              </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6 mt-6 sm:mt-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Импортируй контакты или найди людей по интересам</p>
                  </div>
                  <div className="text-center">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#5865f2] rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <p className="text-[#b9bbbe] text-xs sm:text-sm">Пиши, звони, делись — всё в одном месте</p>
                  </div>
                </div>
              ...
              <div className="bg-[#2f3136] border border-[#202225] rounded-lg p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-bold text-white mb-4">Почему выбирают Волну?</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    ...
                    },
                    {
                      ...
                      title: "Лента и соцсеть",
                      desc: "Делись моментами, реагируй, комментируй",
                    },
                    {
                      icon: <Eye className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Истории и статусы",
                      desc: "Рассказывай о себе каждый день",
                    },
                    {
                      icon: <Shield className="w-4 h-4 sm:w-5 sm:h-5" />,
                      title: "Сквозное шифрование",
                      desc: "Твои переписки видишь только ты",
                    },
                  ].map((feature, index) => (
                    <div
                      key={index}
            ...
            <div className="mb-4">
              ...
              <div className="space-y-2">
                {[
                  {
                    name: "Мария",
                    status: "Общается в Путешественниках",
                    avatar: "М",
